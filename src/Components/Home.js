...
<div>
  <h1 className='my-5 text-gray-400'>I am kaushal and I am a software developer currently pursuing an engineering degree, with expertise in UI/UX design, as well as front-end and back-end development.</h1>
</div>
